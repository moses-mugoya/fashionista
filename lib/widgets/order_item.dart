...
class OrderItem extends StatelessWidget {
  ...
  const OrderItem({super.key, required this.orderNumber, required this.trackingNumber, required this.quantity, required this.orderDate, required this.subTotal});
